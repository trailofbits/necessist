...
| -------------------------- | ---------------------------------------- | --------- | ---- | ----- | ----- | ------- | --------- |
| chainlink                  | v2.16.0                                  |           |      | X     | X     | X       | 0         |
| chainlink_foundry          | v2.16.0                                  | foundry   | X    | X     | X     | X       | 1         |
| chainlink_hardhat          | v2.16.0                                  | hardhat   |      | X     | X     | X       | 0         |
...
| minio                      | RELEASE.2024-10-02T17-50-41Z             |           |      | X     | X     | X       | 1         |
